    ...
    return (
        ...
        >
            ...
            <nav className="mt-6 space-y-1">
                ...
                >
                    <span className="relative z-10">{open ? "Dashboard" : <MdDashboard />}</span>
                </Link>
                ...
                >
                    <span className="relative z-10">{open ? "Posts" : <FaSignsPost />}</span>
                </Link>
                ...
                >
                    <span className="relative z-10">{open ? "Users" : <FaUsers />}</span>
                </Link>
            </nav>
